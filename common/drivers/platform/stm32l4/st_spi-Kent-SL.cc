...
namespace LBR {
    namespace Stml4 {
         ...
         * 
         */
        HwSpi::HwSpi(SPI_Typedef* instance_, SpiCrSettings& settings_) : instance(instance_), settings(settings_), initialized(true) {}
         ...
         * @param pins 
         */
        void HwSpi::SetPins(const SpiPins& spi_pins_) {
            spi_pins = spi_pins_;
        }
         ...
         */
        void HwSpi::SpiConfigSettings(const SpiCrSettings& cfg) {
            settings = cfg;
        }
        ...
        SpiStatus HwSpi::Init() {
            ...
            if (!SetSpiBusMode(settings.mode)) {
                return SpiStatus::INIT_ERR;
            }
