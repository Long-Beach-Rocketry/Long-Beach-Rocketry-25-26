 ...
 * @file st_spi_defs.h
 * @author Kent Hong
 * @brief SPI Driver defines that contain CR1/CR2 register settings and a struct
 * to store the desired settings
 * @version 0.1
 * @date 2025-09-30
 *
 ...
 *
 */
enum class SpiBusMode : std::uint8_t { MODE1 = 0, MODE2, MODE3, MODE4 };
 ...
 *
 */
enum class SpiBitOrder : std::uint8_t { MSB = 0, LSB };
 ...
 *
 */
enum class SpiRxThreshold : std::uint8_t { FIFO_16bit = 0, FIFO_8bit };
