...
/// CONFIG: nSLEEP pin (PA1) - TODO: confirm against board schematic

Stmh7::StGpioSettings nsleep_settings{
    Stmh7::GpioMode::GPOUT, Stmh7::GpioOtype::PUSH_PULL, Stmh7::GpioOspeed::LOW,
    Stmh7::GpioPupd::NO_PULL, 0};

const Stmh7::StGpioParams nsleep_params{nsleep_settings, 1, GPIOA};

/// CONFIG: DRVOFF pin (PA2) - TODO: confirm against board schematic

Stmh7::StGpioSettings drvoff_settings{
    Stmh7::GpioMode::GPOUT, Stmh7::GpioOtype::PUSH_PULL, Stmh7::GpioOspeed::LOW,
    Stmh7::GpioPupd::NO_PULL, 0};

const Stmh7::StGpioParams drvoff_params{drvoff_settings, 2, GPIOA};
...
Stmh7::HwGpio nsleep(nsleep_params);
Stmh7::HwGpio drvoff(drvoff_params);

Board board{.pwm = pwm, .dir = dir, .nsleep = nsleep, .drvoff = drvoff};
