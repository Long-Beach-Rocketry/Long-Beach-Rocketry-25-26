...
class AirbrakeApp : public App {
    ...
    public:
        ...
        void init() override {
            ...
            cout
                ...
                << setw(12) << "Altitude"
                << setw(12) << "Velocity"
                << setw(15) << "Acceleration"
                << setw(12) << "Airbrake"
                << setw(12) << "Recovery"
                << setw(18) << "Rocket State"
                << endl;
            cout << string(89, '-') << endl;
        }
        ...
        void update(const SensorData& data) override
        {
            switch (rocket_state)
            {
                ...
                case RocketState::BRAKES_DEPLOYED: {
                    ...
                    bool reached_retract_time = (time_since_launch >= retract_time_s);
                ...
                case RocketState::BRAKES_RETRACTED: {
                    ...
                    double time_since_launch = data.time_s - launch_time_s;
                    bool reached_apogee = (data.velocity_mps <= 0.0);
                    bool reached_recovery_backup_time = (time_since_launch >= retract_time_s + 1.0);
            ...
            cout
                << setw(8) << data.time_s
                << setw(12) << data.altitude_m
                << setw(12) << data.velocity_mps
                << setw(15) << data.acceleration_mps2
                << setw(12) << airbrake_command.deployment
                << setw(12) << recovery_command.deployment
                << setw(18) << stateToString(rocket_state)
                << endl;
        }
    ...
    private:
        ...
        string stateToString(RocketState state) const {
            switch (state) {
                case RocketState::PRELAUNCH: return "PRELAUNCH";
                case RocketState::LAUNCHED: return "LAUNCHED";
                case RocketState::BRAKES_DEPLOYING: return "BRAKES_DEPLOYING";
                case RocketState::BRAKES_DEPLOYED: return "BRAKES_DEPLOYED";
                case RocketState::BRAKES_RETRACTING: return "BRAKES_RETRACTING";
                case RocketState::BRAKES_RETRACTED: return "BRAKES_RETRACTED";
                case RocketState::RECOVERY_POPPED: return "RECOVERY_POPPED";
