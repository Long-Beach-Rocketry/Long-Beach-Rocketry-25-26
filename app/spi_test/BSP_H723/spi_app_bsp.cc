...
Stmh7::StSpiSettings spi_settings{Stmh7::SpiBaudRate::FPCLK_8, Stmh7::SpiBusMode::MODE1,
...
Stmh7::StGpioSettings gpio_settings{Stmh7::GpioMode::ALT_FUNC, Stmh7::GpioOtype::PUSH_PULL,
...
bool bsp_init()
{
    ...
    RCC->AHB4ENR |= (RCC_AHB4ENR_GPIOBEN | RCC_AHB4ENR_GPIODEN | RCC_AHB4ENR_GPIOGEN);
