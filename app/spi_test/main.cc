...
int main(void)
{
    ...
    LBR::Stml4::StGpioParams miso_pin{
        {GpioMode::ALT_FUNC, GpioOtype::PUSH_PULL, GpioOspeed::HIGH,
         GpioPupd::NO_PULL, 5},  // AF5
        6,
        GPIOA  // PA6 - MISO
    ...
    LBR::Stml4::StGpioParams mosi_pin{
        {GpioMode::ALT_FUNC, GpioOtype::PUSH_PULL, GpioOspeed::HIGH,
         GpioPupd::NO_PULL, 5},  // AF5
        7,
        GPIOA  // PA7 - MOSI
    ...
    // Init SPI Module
    LBR::Stml4::SpiModule spi_module(SPI1, cfg, sck_pin, miso_pin, mosi_pin);

    // Create SPI driver
    LBR::Stml4::HwSpi spi = spi_module.CreateSpi();
